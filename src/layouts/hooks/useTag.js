import { ref, unref, watch, computed, reactive, onMounted, getCurrentInstance } from 'vue'
...
export function useTags() {
	...
	/** 是否隐藏标签页，默认显示 */
	const showTags = ref(storageLocal().getItem('responsive-configure').hideTabs) ?? ref('false')
