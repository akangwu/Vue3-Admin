<!--<template>-->
<!--	<div class="table-box">-->
<!--		<v-table ref="proTable" title="用户列表" ifIndex ifSelect :columns="columns" :request-api="getTableList" :init-param="initParam" :data-callback="dataCallback">-->
...
<!--// 默认不做操作就直接在 VTable 组件上绑定	:requestApi="getUserList"-->
